...
class ControllerPaymentNihaoPayOnlineUnionPay extends Controller {
	public function index() {
		...
		return $this->load->view('default/template/payment/nihaopay_online_unionpay.tpl', $data);
	}
	...
	public function send() {
		...
		$data['callback_url'] = $this->url->link('payment/nihaopay_online_unionpay/callback','',true);
		$data['ipn_url'] = $this->url->link('payment/nihaopay_online_unionpay/ipn','',true);
...
// 		    CURLOPT_URL => $url,
		...
		$json = array();
		$log = new log('catalog_controller_nihaopay_unionpay.log');
	...
	public function callback() {
	    ...
	    $this->load->model('payment/nihaopay_online_unionpay');
